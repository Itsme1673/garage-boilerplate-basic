...
export function TeamList() {
  ...
  return (
    <div>
        ...
        <p className="text-center text-zinc-400">We are developing a GUI library for Python, for use by novices and advanced users alike. It will be easy to install, being a single importable module,
